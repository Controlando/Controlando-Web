     ...
     protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(conexao.abrirConexao()){
                ...
                if(Meta.excluirMeta(Integer.parseInt(request.getParameter("intCodigo")))){
                   out.println("<h2>Meta excluída com sucesso!</h2>");
                    ...
                    out.println("<h2 style='color: #8A2BE2'>Não foi possível excluir o registro de Meta!</h2>");
            ...
            out.println("<fieldset style='border: 1px solid #000000; background-color: white; ' >");
            out.println("<legend style='color: #8A2BE2'> <b>Aviso</b></legend>");
            out.println("<h2 style='color: #8A2BE2'>Erro do sistema: Processo de exclusão de Meta!</h2>");
            out.println("</fieldset");
        }
